...
//		String filename = "/home/jons/00_privat/irb_debugging/perma_0005.irb";
		...
		String folder = new File(DemoIrbFile.class.getClassLoader().getResource("de/labathome/irb").getFile()).getAbsolutePath();
		String filename = folder + "/140114AA/AA011400.irb";
